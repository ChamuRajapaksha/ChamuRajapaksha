...
[![GitHub followers](https://img.shields.io/github/followers/ChamuRajapaksha?style=for-the-badge&logo=github&logoColor=white&color=0f172a)](https://github.com/ChamuRajapaksha)
...
```ts
const chamu = {
  role:       "Software Engineering Student @ WSU London",
...
<table>
  <tr>
    <td width="50%">
      <h3>💸 SaveOnix</h3>
      <p>AI-powered personal finance app built as an SDGP group project. I lead the team and own the AI/chatbot module — including a Mistral 7B-backed financial content guardrail, tier-based message limits, and chat history search.</p>
      <p>
        <img src="https://img.shields.io/badge/Flutter-02569B?style=flat-square&logo=flutter&logoColor=white"/>
        <img src="https://img.shields.io/badge/Dart-0175C2?style=flat-square&logo=dart&logoColor=white"/>
        <img src="https://img.shields.io/badge/Ollama-000000?style=flat-square&logo=ollama&logoColor=white"/>
        <img src="https://img.shields.io/badge/Mistral_7B-blueviolet?style=flat-square"/>
      </p>
    </td>
    <td width="50%">
      <h3>🎮 FragDesk</h3>
      <p>Desktop app for gamers built with Tauri + React + Rust. Features a clipboard manager (SQLite/rusqlite backend with real-time Tauri events) and a live system monitor with Recharts graphs.</p>
      <p>
